...
from app.sso.domain.models.sso_config import SSOProvider, SSOProtocol
...
class SSOProviderCreate(BaseModel):
    ...
    saml_metadata_xml: Optional[str] = Field(None, description="SAML metadata XML (alternative to individual fields)")
    ...
    oidc_authorization_endpoint: Optional[str] = Field(None, description="OIDC authorization endpoint")
    ...
    oidc_discovery_url: Optional[str] = Field(None, description="OIDC discovery URL (alternative to individual endpoints)")
