...
class SlackNotificationStrategy(AbstractNotificationStrategy):
    ...
    async def _create_slack_payload(self, request: NotificationRequest, config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _create_template_payload(self, request: NotificationRequest) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "text": request.template.render_body(template_context)
            }
    
    def _create_default_payload(self, request: NotificationRequest, config: Dict[str, Any]) -> Dict[str, Any]:
...
class SlackThreadManager:
    ...
    def create_threaded_payload(self, base_payload: Dict[str, Any], thread_ts: str) -> Dict[str, Any]:
