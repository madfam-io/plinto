/**
 * Main Plinto client with complete API surface.
 *
 * Provides strongly-typed access to all Plinto authentication and
...
export class PlintoClient extends BaseAPIClient {
