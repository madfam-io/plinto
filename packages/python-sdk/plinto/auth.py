...
class AuthClient:
    ...
    def verify_email(self, token: str) -> User:
        ...
        Raises:
            AuthenticationError: If token is invalid
            PlintoError: If verification fails
        """
        response = self.http.post(
            '/auth/email/confirm',
            json={'token': token}
    ...
    def handle_oauth_callback(
        ...
        Raises:
            ...
            PlintoError: If callback handling fails
        """
        payload = {
            'provider': provider.value,
            'code': code,
    ...
    def unlink_oauth_account(
        ...
        Raises:
            ...
            PlintoError: If unlinking fails
        """
