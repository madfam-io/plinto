"""Multi-Factor Authentication (MFA) module for the Plinto SDK."""
...
class MFAClient:
    ...
    def generate_backup_codes(
        ...
        Raises:
            AuthorizationError: If not authorized
            PlintoError: If generation fails
        """
        payload = {'count': count}
    ...
    def create_challenge(
        ...
        Raises:
            ...
            AuthorizationError: If not authorized
            PlintoError: If challenge creation fails
        """
        payload = {'method': method.value}
