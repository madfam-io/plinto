...
A comprehensive Python SDK for the Janua authentication and user management platform.
"""

__version__ = "1.0.0"
__author__ = "Janua Team"
__email__ = "support@janua.dev"

# Main client
from .client import JanuaClient, create_client
