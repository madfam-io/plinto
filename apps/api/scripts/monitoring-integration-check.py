...
class MonitoringValidator:
    ...
    async def check_endpoint(self, session: aiohttp.ClientSession, service: str, endpoint: str, expected_content: str = None) -> Dict[str, Any]:
    ...
    async def check_frontend_endpoints(self, session: aiohttp.ClientSession) -> List[Dict[str, Any]]:
    ...
    async def test_metrics_collection(self, session: aiohttp.ClientSession) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            test_data = {
                'type': 'adminAction',
                'metadata': {'action': 'test', 'test': True}
            }
