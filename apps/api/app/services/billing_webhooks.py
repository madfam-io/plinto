...
class BillingWebhookHandler:
    ...
    def verify_fungies_signature(payload: bytes, signature: str) -> bool:
        ...
        expected_signature = hmac.new(
            settings.FUNGIES_WEBHOOK_SECRET.encode(),
            payload,
            hashlib.sha256
        ).hexdigest()
        return hmac.compare_digest(signature, expected_signature)
    ...
    @staticmethod
    async def handle_conekta_subscription_created(db: AsyncSession, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    @staticmethod
    async def handle_conekta_subscription_updated(db: AsyncSession, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    @staticmethod
    async def handle_conekta_subscription_canceled(db: AsyncSession, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    @staticmethod
    async def handle_conekta_subscription_paused(db: AsyncSession, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    @staticmethod
    async def handle_conekta_charge_refunded(db: AsyncSession, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    @staticmethod
    async def handle_fungies_payment_success(db: AsyncSession, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    @staticmethod
    async def handle_fungies_payment_failed(db: AsyncSession, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    @staticmethod
    async def handle_fungies_subscription_activated(db: AsyncSession, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    @staticmethod
    async def handle_fungies_subscription_updated(db: AsyncSession, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    @staticmethod
    async def handle_fungies_subscription_cancelled(db: AsyncSession, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    @staticmethod
    async def handle_fungies_subscription_expired(db: AsyncSession, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    @staticmethod
    async def handle_fungies_refund_processed(db: AsyncSession, data: Dict[str, Any]) -> Dict[str, Any]:
