"""
Exception classes for the Plinto Python SDK.
...
class WebhookVerificationError(PlintoError):
...
class OrganizationError(PlintoError):
...
class InvalidStateError(PlintoError):
...
def get_exception_for_error_code(
    ...
    Returns:
        Appropriate PlintoError subclass instance
    """
